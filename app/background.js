...
class ComputerPlayer {
  ...
  makeMove() {
    ...
    const scores = _babel_runtime_corejs3_core_js_stable_instance_fill__WEBPACK_IMPORTED_MODULE_0___default()(_context = new Array(availMoves.length)).call(_context, 0);
...
var player_piece = "";
electron__WEBPACK_IMPORTED_MODULE_4__.ipcMain.on("player_move", (event, arg) => {
  ...
  event.reply("update_positions", _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_0___default()(_context = orchestrator.state).call(_context, val => {
    switch (val) {
      case 0:
        return "";
      case 1:
  ...
  event.reply("update_positions", _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_0___default()(_context2 = orchestrator.state).call(_context2, val => {
    switch (val) {
      case 0:
        return "";
      case 1:
...
electron__WEBPACK_IMPORTED_MODULE_4__.ipcMain.on("get_positions", (event, arg) => {
  var _context3;
  event.reply("update_positions", _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_0___default()(_context3 = orchestrator.state).call(_context3, val => {
    switch (val) {
      case 0:
        return "";
      case 1:
...
electron__WEBPACK_IMPORTED_MODULE_4__.ipcMain.on("player_value", (event, arg) => {
  console.log("player piece: ", arg);
  player_piece = arg;
  let computer_piece = arg == "x" ? "o" : "x";
  computer_player.setPiece(computer_piece);
});
electron__WEBPACK_IMPORTED_MODULE_4__.ipcMain.on("get_saved_games", (event, arg) => {
  event.reply("saved_games", fs__WEBPACK_IMPORTED_MODULE_8__.readdirSync(__dirname + "\\saved"));
});
electron__WEBPACK_IMPORTED_MODULE_4__.ipcMain.on("load_game", (event, arg) => {
...
electron__WEBPACK_IMPORTED_MODULE_4__.ipcMain.on("save_game", (event, arg) => {
